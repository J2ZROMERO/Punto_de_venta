...
public class Ventas_Tabla_Buscar_Proveedor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ventas_Tabla_Buscar_Proveedor frame = new Ventas_Tabla_Buscar_Proveedor();
	 ...
	 * Create the frame.
	 */
	public Ventas_Tabla_Buscar_Proveedor() {
