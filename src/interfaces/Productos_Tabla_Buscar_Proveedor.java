...
public class Productos_Tabla_Buscar_Proveedor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Productos_Tabla_Buscar_Proveedor frame = new Productos_Tabla_Buscar_Proveedor();
	 ...
	 * Create the frame.
	 */
	public Productos_Tabla_Buscar_Proveedor() {
