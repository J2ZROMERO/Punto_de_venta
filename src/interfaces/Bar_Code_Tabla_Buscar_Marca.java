...
public class Bar_Code_Tabla_Buscar_Marca extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Bar_Code_Tabla_Buscar_Marca frame = new Bar_Code_Tabla_Buscar_Marca();
	 ...
	 * Create the frame.
	 */
	public Bar_Code_Tabla_Buscar_Marca() {
