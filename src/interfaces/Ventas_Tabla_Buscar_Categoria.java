...
public class Ventas_Tabla_Buscar_Categoria extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ventas_Tabla_Buscar_Categoria frame = new Ventas_Tabla_Buscar_Categoria();
	 ...
	 * Create the frame.
	 */
	public Ventas_Tabla_Buscar_Categoria() {
