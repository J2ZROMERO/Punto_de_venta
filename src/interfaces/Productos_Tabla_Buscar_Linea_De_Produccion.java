...
public class Productos_Tabla_Buscar_Linea_De_Produccion extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Productos_Tabla_Buscar_Linea_De_Produccion frame = new Productos_Tabla_Buscar_Linea_De_Produccion();
	 ...
	 * Create the frame.
	 */
	public Productos_Tabla_Buscar_Linea_De_Produccion() {
