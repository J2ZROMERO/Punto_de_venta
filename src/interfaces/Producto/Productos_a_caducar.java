...
public class Productos_a_caducar extends JFrame {
	...
	public void ver_datos(String fechaInicial,String fechaFinal) {
		try {
			tbl_ver_movimientos.setModel(DB_productos.model_view_caducados(fechaInicial, fechaFinal));
