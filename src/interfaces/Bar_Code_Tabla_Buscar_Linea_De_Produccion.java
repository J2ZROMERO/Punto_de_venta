...
public class Bar_Code_Tabla_Buscar_Linea_De_Produccion extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Bar_Code_Tabla_Buscar_Linea_De_Produccion frame = new Bar_Code_Tabla_Buscar_Linea_De_Produccion();
	 ...
	 * Create the frame.
	 */
	public Bar_Code_Tabla_Buscar_Linea_De_Produccion() {
