...
public class Devoluciones_Perdidas_Tabla_Buscar_Linea_De_Produccion extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Devoluciones_Perdidas_Tabla_Buscar_Linea_De_Produccion frame = new Devoluciones_Perdidas_Tabla_Buscar_Linea_De_Produccion();
	 ...
	 * Create the frame.
	 */
	public Devoluciones_Perdidas_Tabla_Buscar_Linea_De_Produccion() {
