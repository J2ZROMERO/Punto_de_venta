...
public class Devoluciones_Perdidas_Tabla_Buscar_Proveedor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Devoluciones_Perdidas_Tabla_Buscar_Proveedor frame = new Devoluciones_Perdidas_Tabla_Buscar_Proveedor();
	 ...
	 * Create the frame.
	 */
	public Devoluciones_Perdidas_Tabla_Buscar_Proveedor() {
