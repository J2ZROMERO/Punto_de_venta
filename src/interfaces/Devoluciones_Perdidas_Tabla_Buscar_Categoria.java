...
public class Devoluciones_Perdidas_Tabla_Buscar_Categoria extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Devoluciones_Perdidas_Tabla_Buscar_Categoria frame = new Devoluciones_Perdidas_Tabla_Buscar_Categoria();
	 ...
	 * Create the frame.
	 */
	public Devoluciones_Perdidas_Tabla_Buscar_Categoria() {
