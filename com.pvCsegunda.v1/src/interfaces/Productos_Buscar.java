...
public class Productos_Buscar extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Productos_Buscar frame = new Productos_Buscar();
	...
	public Productos_Buscar() {
		...
		btn_limpiar_marca.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/limpiar.png")));
		...
		btn_limpiar_proveedor.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/limpiar.png")));
		...
		btn_limpiar_categoria.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/limpiar.png")));
		...
		btn_limpiar_linea_de_produccion.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/limpiar.png")));
		...
		btn_limpiar_atributos_de_contenido.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/limpiar.png")));
		...
		btn_buscar_marca.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/buscar.png")));
		...
		btn_buscar_marca.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(txt_marca.getText().equals("")) {
					...
					Productos_Tabla_Buscar_Marca m = new Productos_Tabla_Buscar_Marca();
					m.setVisible(true);
		...
		btn_buscar_proveedor.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/buscar.png")));
		...
		btn_buscar_proveedor.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(txt_proveedor.getText().equals("")) {
					...
					Productos_Tabla_Buscar_Proveedor p = new Productos_Tabla_Buscar_Proveedor();
					p.setVisible(true);
		...
		btn_buscar_categoria.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/buscar.png")));
		...
		btn_buscar_categoria.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(txt_categoria.getText().equals("")) {
					...
					Productos_Tabla_Buscar_Categoria c = new Productos_Tabla_Buscar_Categoria();
					c.setVisible(true);
		...
		btn_buscar_linea_de_produccion.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/buscar.png")));
		...
		btn_buscar_linea_de_produccion.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(txt_linea_de_produccion.getText().equals("")) {
					...
					Productos_Tabla_Buscar_Linea_De_Produccion l = new Productos_Tabla_Buscar_Linea_De_Produccion();
					l.setVisible(true);
		...
		btn_regresar.setIcon(new ImageIcon(Productos_Buscar.class.getResource("/imagenes/flecha.png")));
