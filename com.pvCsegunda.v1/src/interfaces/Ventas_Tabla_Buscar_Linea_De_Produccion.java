...
public class Ventas_Tabla_Buscar_Linea_De_Produccion extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ventas_Tabla_Buscar_Linea_De_Produccion frame = new Ventas_Tabla_Buscar_Linea_De_Produccion();
	 ...
	 * Create the frame.
	 */
	public Ventas_Tabla_Buscar_Linea_De_Produccion() {
